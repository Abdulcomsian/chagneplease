...
@section('main-content')
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          {{$competitionDetail->competitionAiQuestion->aiReport->report}}
        </div>
  ...
  @endif
    ...
    @endphp
    <div class="qs_sec">
      @foreach($competitionDetail->competitionAnswer as  $answer)
      <div class="qs_box">
        <p>
      ...
      @if($competitionDetail->competitionAiQuestion)
        @php
          $aiQuestion = json_decode($competitionDetail->competitionAiQuestion->question);
          $aiAnswer = json_decode($competitionDetail->competitionAiQuestion->answer);
        @endphp 
